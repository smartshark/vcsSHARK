...
setup(
    ...
    install_requires=['mongoengine', 'pygit2==0.24.2', 'pymongo', 'pycoshark>=1.0.1'],
    dependency_links=['git+https://github.com/smartshark/pycoSHARK.git@1.0.1#egg=pycoshark-1.0.1'],
